...
export class SocialsComponent implements OnInit {
  ...
  saveSocial(){
    ...
    if(this.socialForm.valid){
     this.socialForm.controls['social_name'].setValue(this.selectedSocial.social_name);
     this.socialForm.controls['social_icon'].setValue(this.selectedSocial.social_icon);
     this.socialForm.controls['profile_id'].setValue(this.profile.id);
     this.socialForm.controls['click_count'].setValue(0);


     this.socialService.addSocial(this.socialForm.value).toPromise().then((res:any)=>{
      if(res.success){
